...
if(isset($_POST['submitted'])) {
  ...
  if(trim($_POST['checking']) !== '') {
    ...
    if(!isset($hasError)) {
      ...
      $emailTo = 'info@fccornerstone.com';
      $subject = 'Contact Form Submission from '.$name;
      $sendCopy = trim($_POST['sendCopy']);
      $body = "Name: $name \n\nEmail: $email \n\nComments: $comments";
      $headers = 'From: Cornerstone Construction <'.$emailTo.'>' . "\r\n" . 'Reply-To: ' . $email;

      mail($emailTo, $subject, $body, $headers);

      if($sendCopy == true) {
        $subject = 'You emailed Cornerstone Construction LLC';
        $headers = 'From: Cornerstone Construction LLC <noreply@fccornerstone.com>';
