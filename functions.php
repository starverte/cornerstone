 ...
 *
 * To override cornerstone_setup() in a child theme, add your own cornerstone_setup to your child theme's
 * functions.php file.
 */
...
/**
 * Tell WordPress to run cornerstone_setup() when the 'after_setup_theme' hook is run.
 */
...
if ( ! function_exists( 'cornerstone_content_nav' ) ):
/**
 ...
 * Create your own cornerstone_posted_on to override in a child theme
 *
 */
...
/**
 * Flush out the transients used in cornerstone_categorized_blog
 *
 */
...
/**
 * This theme was built with PHP, Semantic HTML, CSS, love, and a Cornerstone.
 */
